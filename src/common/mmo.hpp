...
#define MAX_MAP_PER_SERVER 1500 /// Maximum amount of maps available on a server
	...
	#define INVENTORY_BASE_SIZE 250 // Amount of inventory slots each player has [Custom: 250, the client shows /250]
#endif

#ifndef INVENTORY_EXPANSION_SIZE
	#if PACKETVER_MAIN_NUM >= 20181031 || PACKETVER_RE_NUM >= 20181031 || PACKETVER_ZERO_NUM >= 20181114
		#define INVENTORY_EXPANSION_SIZE 0 // Amount of additional inventory slots a player can have [Custom: none, the base already is the maximum]
	#else
